...
insert into critical_level values (null, "tank_temperature", 2.5, 4.0);
insert into critical_level values (null, "external_temperature", 8, 14);
insert into critical_level values (null, "milk_tank_weight", 3512, 4607);
insert into critical_level values (null, "ph_measurement", 6.8, 7.2);
insert into critical_level values (null, "k_pos_measurement", 35, 47);
insert into critical_level values (null, "na_cl_concentration", 1.0, 1.7);
insert into critical_level values (null, "salmonella_level", 17, 37);
insert into critical_level values (null, "e_coli_level", 35, 49);
insert into critical_level values (null, "listeria_level", 28, 54);